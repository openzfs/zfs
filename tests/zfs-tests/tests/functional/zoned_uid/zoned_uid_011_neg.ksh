...
typeset list_result
list_result=$(sudo -u \#${ZONED_OTHER_UID} unshare --user --map-root-user \
...
create_result=$(sudo -u \#${ZONED_OTHER_UID} unshare --user --map-root-user \
...
typeset snap_result
snap_result=$(sudo -u \#${ZONED_OTHER_UID} unshare --user --map-root-user \
...
typeset prop_result
prop_result=$(sudo -u \#${ZONED_OTHER_UID} unshare --user --map-root-user \
...
destroy_result=$(sudo -u \#${ZONED_OTHER_UID} unshare --user --map-root-user \
...
rename_result=$(sudo -u \#${ZONED_OTHER_UID} unshare --user --map-root-user \
