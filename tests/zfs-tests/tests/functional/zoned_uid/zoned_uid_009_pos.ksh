...
rename_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
...
typeset move_result
move_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
...
escape_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
...
steal_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
