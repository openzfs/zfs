...
quota_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
...
typeset comp_result
comp_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
...
atime_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
...
userprop_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
...
typeset get_result
get_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
