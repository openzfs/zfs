...
typeset snap_result
snap_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
...
typeset list_result
list_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
...
root_snap_result=$(sudo -u \#${ZONED_TEST_UID} unshare --user --map-root-user \
