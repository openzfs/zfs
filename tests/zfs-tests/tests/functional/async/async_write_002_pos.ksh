...
#
# DESCRIPTION:
#	Verify async DIO writes with io_uring — IOPS scaling and data
...
log_assert "Verify async DIO writes with io_uring: IOPS and integrity"
...
# Enable async DIO writes (and reads — same tunable)
if tunable_exists ASYNC_DIO_ENABLED; then
...
log_pass "Async DIO writes with io_uring passed"
