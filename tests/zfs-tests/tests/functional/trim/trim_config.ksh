...
for type in "" "mirror" "anymirror0" "anymirror1" "anymirror2" "anymirror3" "anyraidz1:2" "raidz2" "draid"; do
	...
	if [[ "$type" =~ "anymirror" ]]; then
		...
		VDEV_MAX_MB=$(( floor(4 * MINVDEVSIZE * 0.65 / 1024 / 1024) ))
		VDEV_MIN_MB=$(( floor(4 * MINVDEVSIZE * 0.40 / 1024 / 1024) ))
	fi
