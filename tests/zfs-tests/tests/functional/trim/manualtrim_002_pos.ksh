...
#	4. Remove all files making the free blocks TRIMable.
#	5. Manually TRIM the pool.
#	6. Wait for manual trim issue TRIM IOs for the free blocks.
#	4. Verify the vdevs contain 5% or less allocated blocks.
#	8. Repeat for test for striped, mirrored, and RAIDZ pools.

verify_runnable "global"

log_assert "Run 'zpool trim' verify pool vdevs shrink"
