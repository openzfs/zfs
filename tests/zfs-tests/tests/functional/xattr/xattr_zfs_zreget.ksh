...
#
# DESCRIPTION:
# See OpenZFS issues #5866 and #8858.  This test will ensure the fixes for
...
function cleanup
{
	poolexists txg-number-pool && destroy_pool txg-number-pool
...
log_must zpool import -d $TEST_BASE_DIR txg-number-pool
