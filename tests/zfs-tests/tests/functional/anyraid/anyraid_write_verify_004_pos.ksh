...
#
# DESCRIPTION:
# Write various data patterns to an anyraidz2:2 AnyRAID pool and verify
# they read back correctly after export/import. This tests raidz2 with
# a data width of 2.
#
# STRATEGY:
# 1. Create pool with anyraidz2:2 (5 disks: 2 parity + 2 data = 4 min, use 5)
...
log_assert "anyraidz2:2 pool preserves data correctly across export/import"
...
log_pass "anyraidz2:2 pool preserves data correctly across export/import"
