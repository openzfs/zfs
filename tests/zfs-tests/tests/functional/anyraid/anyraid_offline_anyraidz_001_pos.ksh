...
#
# DESCRIPTION:
# Offlining a disk from an anyraidz1:2 pool with surplus disks
...
#
# STRATEGY:
# 1. Create an anyraidz1:2 pool with 4 disks (minimum is 3).
...
log_assert "Offlining a disk from an anyraidz1:2 pool with surplus disks preserves data"

#
# Create sparse disk files and pool.
#
log_must create_sparse_files "disk" 4 $DEVSIZE
log_must zpool create -f $TESTPOOL anyraidz1:2 $disk0 $disk1 $disk2 $disk3
...
#
# Offline the fourth disk.
#
log_must zpool offline $TESTPOOL $disk3

#
# Verify the pool is DEGRADED.
#
log_must check_state $TESTPOOL "" "degraded"
log_must check_state $TESTPOOL $disk3 "offline"
...
#
log_must zpool online $TESTPOOL $disk3
...
log_pass "Offlining a disk from an anyraidz1:2 pool with surplus disks preserves data"
