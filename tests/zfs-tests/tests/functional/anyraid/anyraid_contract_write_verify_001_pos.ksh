...
#
# DESCRIPTION:
# Write various data patterns to an anymirror1 AnyRAID pool, contract
# the pool by removing one disk, then verify all data reads back
# correctly. This tests that contraction preserves data integrity
# for mirror-style AnyRAID.
#
# STRATEGY:
# 1. Create pool with anymirror1 (4 disks)
...
log_note "DEBUG: creating sparse files (4 disks)"
...
log_assert "anymirror1 contraction preserves data correctly across export/import"
...
log_pass "anymirror1 contraction preserves data correctly across export/import"
