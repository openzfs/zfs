...
#
# DESCRIPTION:
# Write various data patterns to an anyraidz1:1 AnyRAID pool, contract
...
# for raidz1 with data width of 1.
#
# STRATEGY:
# 1. Create pool with anyraidz1:1 (4 disks, min width=2, so 2 surplus)
...
log_assert "anyraidz1:1 contraction preserves data correctly across export/import"

log_note "DEBUG: creating anyraidz1:1 pool with 4 disks"
...
log_pass "anyraidz1:1 contraction preserves data correctly across export/import"
