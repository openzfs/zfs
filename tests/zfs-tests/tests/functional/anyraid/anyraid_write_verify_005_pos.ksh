...
#
# DESCRIPTION:
# Write various data patterns to an anyraidz3:3 AnyRAID pool and verify
# they read back correctly after export/import. This tests raidz3 with
# a data width of 3.
#
# STRATEGY:
# 1. Create pool with anyraidz3:3 (7 disks: 3 parity + 3 data = 6 min, use 7)
...
log_must truncate -s 1G $TEST_BASE_DIR/vdev_file.{0,1,2,3,4,5,6}

set_tunable64 ANYRAID_MIN_TILE_SIZE 67108864

log_assert "anyraidz3:3 pool preserves data correctly across export/import"

log_must create_pool $TESTPOOL anyraidz3:3 \
	$TEST_BASE_DIR/vdev_file.{0,1,2,3,4,5,6}
...
log_pass "anyraidz3:3 pool preserves data correctly across export/import"
