...
#
# DESCRIPTION:
# Write various data patterns to an anyraidz1:1 AnyRAID pool and verify
# they read back correctly after export/import. This tests raidz1 with
# a data width of 1.
#
# STRATEGY:
# 1. Create pool with anyraidz1:1 (3 disks)
...
log_assert "anyraidz1:1 pool preserves data correctly across export/import"

log_must create_pool $TESTPOOL anyraidz1:1 \
...
log_pass "anyraidz1:1 pool preserves data correctly across export/import"
