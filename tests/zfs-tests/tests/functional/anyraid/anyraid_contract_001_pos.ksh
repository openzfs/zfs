...
#
# DESCRIPTION:
# Basic contraction on anymirror1 preserves data integrity.
# Removes one disk from a pool with surplus disks and verifies
# all data checksums are unchanged.
#
# STRATEGY:
# 1. Create anymirror1 pool with 5 equal-sized disks
...
log_assert "Basic contraction on anymirror1 preserves data integrity"
...
log_pass "Basic contraction on anymirror1 preserves data integrity"
