...
create_pool_test "$TESTPOOL" "anymirror" "$anyraiddevs"
create_pool_test "$TESTPOOL" "anymirror0" "$anyraiddevs"
...
create_pool_test "$TESTPOOL" "anyraidz1:2" "$anyraiddevs"
create_pool_test "$TESTPOOL" "anyraidz1:3" "$anyraiddevs"
create_pool_test "$TESTPOOL" "anyraidz2:2" "$anyraiddevs"
create_pool_test "$TESTPOOL" "anyraidz3:1" "$anyraiddevs"
