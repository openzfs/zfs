...
#
# STRATEGY:
#	1. Create a pool and create a 10MB file in it (not using indirect blocks).
...
log_assert "Verify small file scrub"
...
log_must fio --rw=write --name=job --size=12M --filename=/$TESTPOOL/10m_file
