...
#
# DESCRIPTION:
# Verify that an anyraidz1:2 vdev can be added to an existing
# traditional raidz1 pool.
#
# STRATEGY:
# 1. Create a pool with a traditional raidz1 vdev.
# 2. Add an anyraidz1:2 vdev to the pool using -f.
...
log_assert "anyraidz1:2 vdev can be added to a traditional raidz1 pool"
log_onexit cleanup

create_sparse_files "disk" 6 $MINVDEVSIZE2

log_must zpool create $TESTPOOL raidz1 $disk0 $disk1 $disk2
log_must poolexists $TESTPOOL

log_must zpool add -f $TESTPOOL anyraidz1:2 $disk3 $disk4 $disk5
...
log_pass "anyraidz1:2 vdev can be added to a traditional raidz1 pool"
