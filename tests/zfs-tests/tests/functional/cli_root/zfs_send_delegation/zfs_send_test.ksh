...
# user tests under ../cli_user/zfs_send_delegation_user/
...
log_must zfs unallow testerbot send $TESTPOOL/$TESTFS1
...
zfs unallow testerbot send:raw $TESTPOOL/$TESTFS1
zfs allow testerbot send $TESTPOOL/$TESTFS1
