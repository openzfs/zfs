...
#	2. Create pool with 4 cache devices.
...
# Test parameters
typeset num_devs=4
typeset cache_sz=520  # 2080MB total > 2GB (arc_max*2) threshold
...
# Set L2ARC_WRITE_MAX to 16MB/s per device (64MB/s total with 4 devices)
...
# Create cache devices (using letters e-h to follow cfg naming convention)
typeset cache_devs=""
...
# expected = 16MB/s * 4 devices * 10 seconds = 640MB
