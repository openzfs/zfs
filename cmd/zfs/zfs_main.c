...
/*
 * zfs hold [-r] [-t] <tag> <filesystem|volume|snapshot> ...
 *
 *	-r	Recursively hold
 *
 * Apply a user-hold with the given tag to the list of datasets.
 */
static int
...
/*
 * zfs release [-r] <tag> <filesystem|volume|snapshot> ...
 *
 *	-r	Recursively release
 *
 * Release a user-hold with the given tag from the list of datasets.
 */
static int
