...
zpool_get_all_props(zpool_handle_t *zhp)
{
	...
	props = zprop_conv_zpool_from_strings(zhp->zpool_props);
	nvlist_free(zhp->zpool_props);
	zhp->zpool_props = props;
...
zpool_set_prop(zpool_handle_t *zhp, const char *propname, const char *propval)
{
	...
	nvlist_free(nvl);
	nvl = zprop_conv_zpool_from_strings(realprops);
	nvlist_free(realprops);
    ...
    const char *log_str)
{
	...
	fnvlist_add_string(opts, "log_history", log_str);
	if (force)
