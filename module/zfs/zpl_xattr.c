...
#if defined(HAVE_GENERIC_PERMISSION_CHECK_ACL)
...
static int
nfs4acl_key_instantiate(struct key *k,
#if defined(HAVE_STRUCT_KEY_PREPARSED_PAYLOAD)
	    struct key_preparsed_payload *kpp)
#else
...
#if defined(HAVE_KEY_IS_POSITIVE)
