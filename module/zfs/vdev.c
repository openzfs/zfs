...
vdev_alloc_common(spa_t *spa, uint_t id, uint64_t guid, vdev_ops_t *ops)
{
	...
	vd->vdev_obsolete_segments = zfs_range_tree_create_usecase(
	    NULL, ZFS_RANGE_SEG64, NULL, 0, 0,
	    ZFS_RANGE_TREE_UC_UNKNOWN, "vdev_obsolete_segments");
	...
	for (int t = 0; t < DTL_TYPES; t++) {
		vd->vdev_dtl[t] = zfs_range_tree_create_usecase(
		    NULL, ZFS_RANGE_SEG64, NULL, 0, 0,
		    ZFS_RANGE_TREE_UC_UNKNOWN, "vdev_dtl");
	}
...
vdev_dtl_load(vdev_t *vd)
{
	...
	if (vd->vdev_ops->vdev_op_leaf && vd->vdev_dtl_object != 0) {
		...
		rt = zfs_range_tree_create_usecase(
		    NULL, ZFS_RANGE_SEG64, NULL, 0, 0,
		    ZFS_RANGE_TREE_UC_ALLOCATED_SPACE, "vdev_dtl_load:rt");
