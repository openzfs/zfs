...
dbuf_stats_hash_table_headers(char *buf, size_t size)
{
	size = snprintf(buf, size - 1,
	    ...
	    "blkid", "offset", "size", "meta", "state", "holds", "list",
	    "type", "index", "flags", "count", "size", "access", "mru", "gmru",
	    "mfu", "gmfu", "l2", "l2_dattr", "l2_asize", "l2_comp", "holds",
	    "type", "btype", "data_bs", "meta_bs", "bsize",
	    "lvls", "holds", "blocks", "size");
        buf[size] = '\0';
