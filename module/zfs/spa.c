    ...
    int rebuild)
{
	...
	if (!replacing) {
		...
		zfs_dbgmsg("newvd isspare %d, %s, newrootvd isspare %d, %s",
		    newvd->vdev_isspare, newvd->vdev_ops->vdev_op_type,
		    newrootvd->vdev_isspare,
		    newrootvd->vdev_ops->vdev_op_type);
