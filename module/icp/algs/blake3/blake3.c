...
/*
 * We need about 1500 byte for stack size. /TR
 */
#if defined(__GNUC__)
...
#ifdef _KERNEL
EXPORT_SYMBOL(Blake3_Init);
EXPORT_SYMBOL(Blake3_InitKeyed);
EXPORT_SYMBOL(Blake3_Update);
EXPORT_SYMBOL(Blake3_Final);
EXPORT_SYMBOL(Blake3_FinalSeek);
#endif
