...
static void
_sha256_generic(uint32_t state[8], const void *data, size_t num_blks)
{
	uint64_t blk;
...
static void
_sha512_generic(uint64_t state[8], const void *data, size_t num_blks)
{
	uint64_t blk;
...
static void
_sha256_update(sha256_ctx *ctx, const uint8_t *data, size_t len)
{
...
static void
_sha512_update(sha512_ctx *ctx, const uint8_t *data, size_t len)
{
	uint64_t pos = ctx->count[0];
	uint64_t total = ctx->count[1];
	uint8_t *m = ctx->wbuf;
...
static void
_sha256_final(sha256_ctx *ctx, uint8_t *result, int bits)
{
...
static void
_sha512_final(sha512_ctx *ctx, uint8_t *result, int bits)
{
	uint64_t mlen, pos = ctx->count[0];
...
SHA2Update(SHA2_CTX *ctx, const void *data, size_t len)
{
	...
	switch (ctx->algotype) {
		case SHA256:
			_sha256_update(&ctx->sha256, data, len);
			break;
		case SHA512:
		case SHA512_HMAC_MECH_INFO_TYPE:
			_sha512_update(&ctx->sha512, data, len);
			break;
		case SHA512_256:
			_sha512_update(&ctx->sha512, data, len);
			break;
...
SHA2Final(void *digest, SHA2_CTX *ctx)
{
	switch (ctx->algotype) {
		case SHA256:
			_sha256_final(&ctx->sha256, digest, 256);
			break;
		case SHA512:
		case SHA512_HMAC_MECH_INFO_TYPE:
			_sha512_final(&ctx->sha512, digest, 512);
			break;
		case SHA512_256:
			_sha512_final(&ctx->sha512, digest, 256);
			break;
	}
}
...
const sha256_ops_t sha256_generic_impl = {
	.name = "generic",
	.transform = _sha256_generic,
	.is_supported = _sha2_is_supported
};

const sha512_ops_t sha512_generic_impl = {
	.name = "generic",
	.transform = _sha512_generic,
	.is_supported = _sha2_is_supported
};
