...
int64_t zfs_refcount_add_many_nv(zfs_refcount_t *, uint64_t, const void *);
void zfs_refcount_add_many(zfs_refcount_t *, uint64_t, const void *);
...
#define	zfs_refcount_add_many_nv(rc, number, holder) \
