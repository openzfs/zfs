...
enum zio_stage {
	...
	ZIO_STAGE_ISSUE_ASYNC		= 1 << 4,	/* -WF-XT */
	...
	ZIO_STAGE_VDEV_IO_FLUSH		= 1 << 22,	/* -W---- */
	ZIO_STAGE_VDEV_IO_DONE		= 1 << 23,	/* RW--XT */
	ZIO_STAGE_VDEV_IO_ASSESS	= 1 << 24,	/* RW--XT */

	ZIO_STAGE_CHECKSUM_VERIFY	= 1 << 25,	/* R----- */
	ZIO_STAGE_DIO_CHECKSUM_VERIFY	= 1 << 26,	/* -W---- */

	ZIO_STAGE_DONE			= 1 << 27	/* RWFCXT */
};
...
#define	ZIO_VDEV_IO_COMMON_STAGES		\
	(ZIO_STAGE_VDEV_IO_START |		\
	ZIO_STAGE_VDEV_IO_DONE |		\
	ZIO_STAGE_VDEV_IO_ASSESS)

#define	ZIO_VDEV_IO_WRITE_STAGES		\
	(ZIO_VDEV_IO_COMMON_STAGES |		\
...
#define	ZIO_VDEV_CHILD_WRITE_PIPELINE		\
	(ZIO_VDEV_IO_WRITE_STAGES |		\
	ZIO_STAGE_DONE)
