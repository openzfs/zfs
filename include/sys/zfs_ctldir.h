 ...
 * These values are carefully chosen to ensure they don't conflict with
 * normal file system inodes which are assigned monotonically starting
 * at one.  The snapshot and shares sub directories are allocated
 * starting at 2^64-1 downward so as not to conflict.  In addition,
